    ...
    // case 3. test with 0 - 500 
    {
        for(size_t num_of_keys = 1000; num_of_keys < 1000000; num_of_keys += 1000){
            for(double fpr = 0.01 ; fpr < .25 ; fpr = fpr + 0.01){
                ...
                auto dur = std::chrono::duration_cast<std::chrono::nanoseconds>(end_t - begin).count() ; 
                // query case (1)
                ...
                auto dur2 = std::chrono::duration_cast<std::chrono::nanoseconds>(end_t - begin).count() ; 
                ...
                end_t = std::chrono::steady_clock::now();
                auto dur3 = std::chrono::duration_cast<std::chrono::nanoseconds>(end_t - begin).count() ; 
